...
export class CustomerServiceService {
  ...
  constructor() {
    ...
    this.customerList.push(new Customer('Bùi Hùng', 3, '1993-01-10', 1, '0123456', '4564545', 'hung123@gmail.com', 'Quảng Nam'));
    this.customerList.push(new Customer('Văn Phúc', 4, '1998-01-10', 1, '0123456', '4564545', 'phuc123@gmail.com', 'Nghệ An'));
    this.customerList.push(new Customer('Đại Lợi', 3, '1997-01-10', 1, '0123456', '4564545', 'loi123@gmail.com', 'Đà Nẵng'));
  }
